...
La versión final del trabajo puede visualizarse en: <https://Rucamcam.github.io/trabajo_BigData/>. 
...
El título del trabajo es "las mejores ligas europeas de fútbol", trabajo donde, a partir de los datos de la temporada 20/21 de La Liga (liga española), Ligue 1 (liga francesa), Serie A (liga italiana), Bundesliga (liga alemana) y Premier League (liga inglesa), se hace un análisis de, principalmente, los goles, rating, tarjetas, etc de los equipos que componen dichas ligas.
